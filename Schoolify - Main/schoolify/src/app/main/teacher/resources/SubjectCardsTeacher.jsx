...
export default function SubjectCardsTeacher() {
    ...
    const subjects = {
        "Grade 6 - 10": [
            { title: "Mathematics", img: "/img/Subjects/mathematics.jpg" },
            { title: "Science", img: "/img/Subjects/science.jpg" },
            { title: "English", img: "/img/Subjects/english.jpg" },
            { title: "History", img: "/img/Subjects/history.jpg" },
            { title: "Religion", img: "/img/Subjects/religion.jpg" },
            { title: "Sinhala", img: "/img/Subjects/sinhala.jpg" },
            { title: "PTS", img: "/img/Subjects/pts.jpg" },
            { title: "Arts", img: "/img/Subjects/optional 2.jpg" },
        ],
        "Ordinary Level (O/L)": [
            { title: "Mathematics", img: "/img/Subjects/mathematics.jpg" },
            { title: "Science", img: "/img/Subjects/science.jpg" },
            ...
            { title: "Religion", img: "/img/Subjects/religion.jpg" },
            { title: "Sinhala", img: "/img/Subjects/sinhala.jpg" },
            { title: "Optional 01", img: "/img/Subjects/optional 1.jpg" },
            { title: "Optional 02", img: "/img/Subjects/optional 2.jpg" },
            { title: "Optional 03", img: "/img/Subjects/optional 3.jpg" },
        ],
        "Advanced Level (A/L)": {
            "Mathematics Stream": [
                { title: "Mathematics", img: "/img/Subjects/mathematics.jpg" },
                { title: "Physics", img: "/img/Subjects/physics.jpg" },
                { title: "Chemistry", img: "/img/Subjects/chemistry.jpg" },
            ],
            "Biological Science Stream": [
                { title: "Biology", img: "/img/Subjects/biology.jpg" },
                { title: "Chemistry", img: "/img/Subjects/chemistry.jpg" },
                { title: "Physics", img: "/img/Subjects/physics.jpg" },
            ],
            "Commerce Stream": [
                { title: "Commerce", img: "/img/Subjects/commerce.jpg" },
                { title: "Accounting", img: "/img/Subjects/econ.jpg" },
                { title: "Business Studies", img: "/img/Subjects/business studies.jpg" },
            ],
            "Arts Stream": [
