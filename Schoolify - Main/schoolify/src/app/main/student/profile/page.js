...
export default async function ProfilePage() {
  ...
  try {
    // Fetch basic user info from the "users" table, including profile_image_url
    ...
    // Fetch personal details from the "personal_details" table
    const personalQuery = `
    ...
    // Fetch guardian details from the "guardian_details" table
    const guardianQuery = `
