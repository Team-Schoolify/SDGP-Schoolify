...
export default function StudentProfile() {
    ...
    useEffect(() => {
        const fetchParents = async () => {
            ...
            const { data, error } = await supabase
                .from("parent")
                .select("parent_id, parent_name, parent_email, photo")
                .eq("student_id", studentId);
    ...
    return (
        <Card className="w-full bg-gray-100 text-black flex flex-col py-8 px-4 rounded-none relative">
            {/* Go Back Icon */}
            <button
                onClick={() => router.back()}
            ...
            >
                ...
                <span className="ml-2 text-lg text-success">Go Back</span>
            </button>
                ...
                <div className="text-lg leading-relaxed">
                    ...
                    <div className="border-none py-4 bg-white shadow-sm">
                        <div className="grid grid-cols-[200px_1fr] px-4">
                            ...
                            <p className="font-semibold py-4 border-b">Gender:</p> <p className="py-4 border-b">Male</p>
                            <p className="font-semibold py-4 border-b">Date of Birth:</p> <p className="py-4 border-b">15th June 2010</p>
