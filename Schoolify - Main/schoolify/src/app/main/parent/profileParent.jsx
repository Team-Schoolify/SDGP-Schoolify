    ...
    useEffect(() => {
        const fetchParent = async () => {
            ...
            const { data, error } = await supabase
                .from("parent")
                .select("parent_id, parent_name, parent_email, photo, school_id")
            ...
            if (error) {
                ...
                console.log("Updated parent object:", data[0]); // ✅ Debugging log
            } else {
            ...
            <Popover placement="top" showArrow={true} backdrop="blur">
                ...
                <PopoverContent>
                    <div className="p-5 flex flex-col text-left gap-y-3">
                        ...
                        <div className="text-lg font-bold">Name: {parent?.parent_name || "asda"}</div>
                        <div className="text-lg">Email: {parent?.parent_email || "asdsa"}</div>
