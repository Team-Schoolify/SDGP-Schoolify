...
"[project]/lib/auth/db.js [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/auth/db.js [api] (ecmascript)");
;
;
;
async function handler(req, res) {
    ...
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["query"])(userQuery, [
            email
        ]);
        ...
        const isValidPassword = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcryptjs__$5b$external$5d$__$28$bcryptjs$2c$__cjs$29$__["default"].compare(password, user.password);
        if (!isValidPassword) {
            return res.status(401).json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__2f069b._.js.map